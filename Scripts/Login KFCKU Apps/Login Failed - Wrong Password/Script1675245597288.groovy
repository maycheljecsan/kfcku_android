...
Mobile.setText(findTestObject('Login/android.widget.EditText - Ketik kata sandi Anda'), 'qwerty123', 0)
...
Mobile.verifyElementVisible(findTestObject('Login/android.widget.TextView - Kata sandi yang Anda masukkan salah'), 3)

Mobile.verifyElementText(findTestObject('Login/android.widget.TextView - Kata sandi yang Anda masukkan salah'), 'Kata sandi yang Anda masukkan salah')
