...
Mobile.setText(findTestObject('Login/android.widget.EditText - Masukkan nomor handphone Anda'), '081211287388', 0)
...
Mobile.waitForElementPresent(findTestObject('Login/android.widget.TextView - Nomor handphone Anda belum terdaftar'), 3)
