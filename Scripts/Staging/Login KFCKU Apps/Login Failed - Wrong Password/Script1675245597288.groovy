...
Mobile.waitForElementPresent(findTestObject('Login/android.widget.TextView - Kata sandi yang Anda masukkan salah'), 3)

Mobile.waitForElementPresent(findTestObject('Login/android.widget.TextView - Kata sandi yang Anda masukkan salah'), 0)
