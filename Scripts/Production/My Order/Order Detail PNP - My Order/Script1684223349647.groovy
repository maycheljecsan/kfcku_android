...
Mobile.verifyElementVisible(findTestObject('Productions/My Order/Order Detail - PNP/Order Type'), 0)

Mobile.verifyElementVisible(findTestObject('Productions/My Order/Order Detail - PNP/Pick Up Outlet'), 0)
...
Mobile.verifyElementVisible(findTestObject('Productions/My Order/Order Detail - PNP/Order Summary'), 0)
